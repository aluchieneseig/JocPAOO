...
public abstract class MapObject {
    ...
    public void checkTileMapCollision() {
        ...
        damaging = (tileMap.getType(currRow, currCol) == Tile.DAMAGE);
        escaping = (tileMap.getType(currRow, currCol) == Tile.ESCAPE);
        if(tileMap.getType(currRow,currCol) == Tile.COLLECT) {
            collecting = true;
            System.out.println("Coin!");
            tileMap.deleteEntity(currRow, currCol);
        }
